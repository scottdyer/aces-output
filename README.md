...
[![CLA
assistant](https://cla-assistant.io/readme/badge/aces-aswf/aces-output)](https://cla-assistant.io/aces-aswf/aces-output)

This repository provides CTL transforms with predefined parameter sets that
invoke functions from [aces-core](https://github.com/aces-aswf/aces-core) to produce
...
The [ACES documentation](https://docs.acescentral.com/) explains the available Output
